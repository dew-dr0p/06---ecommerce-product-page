<template>
    <div class="m-5 mr-20">
        <img src="../../public/assets/image-product-1.jpg" alt="" class="rounded-3xl mb-10">
        <img src="../../public/assets/image-product-1-thumbnail.jpg" alt="" class="mr-5 rounded-2xl border-4 border-orange backdrop-opacity-25">
    </div>
    <div class="m-auto ml-20">
        <h5 class="uppercase text-orange font-bold mb-5" style="letter-spacing: 2.75px;">Sneaker Company</h5>
        <h1 class="text-6xl font-bold mb-14">Fall Limited Edition Sneakers</h1>
        ...
        <div class="grid grid-cols-[2fr,.5fr,3fr] items-center">
            <div class="flex flex-row p-5 py-3 bg-blue-grayish-light w-full text-3xl font-bold items-center justify-between rounded-lg">
                <img src="../../public/assets/icon-minus.svg" alt="">
                <p class="text-xl font-bold">0</p>
                <img src="../../public/assets/icon-plus.svg" alt="">
            </div>
            <div></div>
            <div class="flex flex-row p-5 py-3 bg-orange text-white w-full text-3xl font-bold items-center justify-center rounded-lg">
                <img src="../../public/assets/icon-cart.svg" alt="" class="">
